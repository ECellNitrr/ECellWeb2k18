...
+function(a){
    ...
    var c="lte.boxrefresh",d={
        ...
        ,trigger:".refresh-btn",content:".box-body",loadInContent:!0,responseType:"",overlayTemplate:'<div class="overlay"><div class="fa fa-refresh fa-spin"></div></div>',onLoadStart:function(){
        }
...
(jQuery),function(a){
    ...
    ,g={
        collapsed:"collapsed.boxwidget",expanded:"expanded.boxwidget",removed:"removed.boxwidget"
    }
    ,h=function(a,b){
...
(jQuery),function(a){
    ...
    ,f={
        open:"control-sidebar-open",fixed:"fixed"
    }
    ,g={
        collapsed:"collapsed.controlsidebar",expanded:"expanded.controlsidebar"
    }
    ,h=function(a,b){
    ...
    ,h.prototype._fixForBoxed=function(b){
        b.css({
            position:"absolute",height:a(e.wrapper).height()
        }
        )
    }
    ;
...
(jQuery),function(a){
    ...
    var c="lte.directchat",d={
        data:'[data-widget="chat-pane-toggle"]',box:".direct-chat"
    }
    ,e={
...
(jQuery),function(a){
    ...
    ,f={
        fixed:"fixed",holdTransition:"hold-transition"
    }
    ,g=function(a){
...
(jQuery),function(a){
    ...
    ,g={
        expanded:"expanded.pushMenu",collapsed:"collapsed.pushMenu"
    }
    ,h=function(a){
...
(jQuery),function(a){
    ...
    ,f={
        open:"menu-open",tree:"tree"
    }
    ,g={
        collapsed:"collapsed.tree",expanded:"expanded.tree"
    }
    ,h=function(b,c){
